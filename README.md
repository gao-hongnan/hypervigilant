...
[![Python](https://img.shields.io/badge/python-3.13%20%7C%203.14-blue.svg)](https://www.python.org/downloads/)
[![PyPI](https://img.shields.io/badge/pypi-v28.1.1-blue.svg)](https://github.com/gao-hongnan/hypervigilant)
...
```bash
git commit -m "release: v28.1.1" && \
    git push origin main && \
    git tag v28.1.1 && \
    git push origin v28.1.1
```
